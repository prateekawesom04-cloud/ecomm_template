                                    <div class="single_product_item mb-5 relative productInfo" data-product_id="{{$product->product_id}}" data-image="{{asset('storage').'/'.json_decode($product->image)[0]}}" data-title="{{$product->title}}" data-price="{{$product->price}}">
                                        <div class="img_div">
                                        ...
                                        <div class="absolute top-0 right-0 m-3 w-[20px] h-[20px] z-[999] cursor-pointer{{($currentUser)?' loginTrue':''}} app_product_heart" data-product_id="{{$product->product_id}}">
