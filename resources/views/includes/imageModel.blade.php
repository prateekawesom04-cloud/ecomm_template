...
<div class="app_custom_modal imageModel flex flex-col" style="display:none;">
    <div class="app_modal_body h-[80%] w-[80%] justify-start p-5 app_col app_content_box relative bg-transparent">
        ...
        <img src="" class="w-full h-full product_image">
    </div>
</div>
